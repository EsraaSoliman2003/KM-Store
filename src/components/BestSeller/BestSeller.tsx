        ...
        <section className="py-14">
            <div className="container">
                ...
                <div className="mb-8 flex flex-col gap-5 sm:gap-6 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <Link href={"/best-sellers"} className="group mx-auto lg:mx-0 flex w-fit items-center gap-2 self-start text-lg text-purple-400 transition-all duration-300 hover:text-purple-300 lg:self-auto">
